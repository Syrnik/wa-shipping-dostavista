...
const props = defineProps({modelValue: {type: Object}}),
    ...
    namespace = addns('customer_interval', inject('namespace')),
    interval_row = {
        from: '10',
        from_m: '00',
        to: '12',
...
function deleteInterval(idx) {
    ...
    if (intervals.length > 1) {
        ...
        intervals[0] = Object.assign({}, interval_row);
    }
            ...
            <table class="zebra w-shipping-dostavista__interval-control-table small">
                ...
                <tr v-for="(interval, idx) in setting.intervals">
                    ...
                    <td><a class="inline-link"
                           @click.prevent="deleteInterval(idx)"><i
                        class="icon16 delete fa fa-trash-alt text-red"></i></a></td>
                </tr>
                </tbody>
            </table>
        </div>
