        ...
        <div id="" class="drawer">
            ...
            <div class="drawer-body">
                ...
                <div class="drawer-block w-syrnik-shipping-ui">
                    <header class="drawer-header"><h1><slot name="header">Формула для расчёта наценки</slot></h1></header>
                    <div class="drawer-content">
                        ...
                        <p>Можно использовать математические символы (сложение, деление, вычитание, умножение и т.д.), скобки
